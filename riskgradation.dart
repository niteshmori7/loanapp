...
class loanapp27 extends StatefulWidget {
  const loanapp27({super.key});

  @override
  State<loanapp27> createState() => _loanapp5State();
}

class _loanapp5State extends State<loanapp27> {
  @override
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text("1.Who we are",style: GoogleFonts.mirza(fontWeight: FontWeight.bold,fontSize: 24),),
            ),
            Padding(
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Text(
                    "3. Internal Risk model & Risk Gradation",
                    style: GoogleFonts.mirza(
