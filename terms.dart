...
class loanapp24 extends StatefulWidget {
  const loanapp24({super.key});

  @override
  State<loanapp24> createState() => _loanapp5State();
}

class _loanapp5State extends State<loanapp24> {
  @override
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text(
                        "Terms & conditions for application for",
                ...
                Padding(
                  ...
                  child: Text("loan :",style: GoogleFonts.mirza(fontSize: 24,fontWeight: FontWeight.bold),),
                )
              ],
            ),
            Column(
